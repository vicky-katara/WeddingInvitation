...
\vspace{12pt}
\textbf{Time}: (Engagement) 7 PM - October 18th, 2018;\\ (Reception) @ 4 PM - October 19th, 2018\\
\vspace{12pt}
\textbf{Location}: 
Avion Hotel\\
...
\vspace{12pt}
\foreignlanguage{sanskrit}{\textbf{समय}}: (\foreignlanguage{sanskrit}{सगाई}) \foreignlanguage{sanskrit}{शाम ७ बजे}, \foreignlanguage{sanskrit}{अक्टूबर १८, २०१८} ; (\foreignlanguage{sanskrit}{रिसेप्शन}) \foreignlanguage{sanskrit}{शाम ४ बजे}, \foreignlanguage{sanskrit}{अक्टूबर १९, २०१८} \\
\vspace{12pt}
\foreignlanguage{sanskrit}{\textbf{स्थान}}: Avion Hotel\\
